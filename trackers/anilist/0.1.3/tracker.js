...
var ANILIST_REDIRECT_URI = "https://porksphere.github.io/comical-app/oauth-relay.html";
var SETTINGS = defineSettings([
  {
    ...
    required: true,
    authUrl: "https://anilist.co/api/v2/oauth/authorize" + `?client_id=${ANILIST_CLIENT_ID}` + "&response_type=token" + `&redirect_uri=${encodeURIComponent(ANILIST_REDIRECT_URI)}`
  }
]);
var TO_TRACKER = {
  CURRENT: "reading",
...
//# debugId=7BFF55030FD6B54D64756E2164756E21
